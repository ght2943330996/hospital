...
public class RegistrationController {
     ...
     */
    @PutMapping("/pay")
    public Result payById(@RequestBody Registration registration) {
        registrationService.payById(registration);
        return Result.success();
    }
     ...
     */
    @PutMapping("/refund")
    public Result refundById(@RequestBody Registration registration) {
        registrationService.refundById(registration);
        return Result.success();
    }
