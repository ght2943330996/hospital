      ...
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="center" width="180">
          <template v-slot="scope">
            ...
            <el-button size="mini" type="danger" plain @click="del(scope.row.id)" v-if="scope.row.id === 1"disabled>删除</el-button>
            <el-button size="mini" type="danger" plain @click="del(scope.row.id)" v-else="scope.row.id !== 1">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
