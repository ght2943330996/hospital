  ...
  <div class="manager-container">
    ...
    <div class="manager-main">
      ...
      <div class="manager-main-left">
        <el-menu :default-openeds="['info', 'reserve' , 'reg' ,'user']" router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="reserve" >
            ...
            <el-menu-item index="/doctorCard" v-if="user.role !== 'NURSE'">预约挂号</el-menu-item>
            <el-menu-item index="/reserve" v-if="user.role !== 'NURSE'">患者叫号</el-menu-item>
            <el-menu-item index="/record">我的就诊</el-menu-item>
          </el-submenu>

          <el-submenu index="reg">
            <template slot="title">
              <i class="el-icon-menu"></i><span>我的登记</span>
            </template>
            <el-menu-item index="/registration">住院登记</el-menu-item>
            <el-menu-item index="/medical">医药登记</el-menu-item>
          </el-submenu>
          ...
          <el-submenu index="user" v-if="user.role === 'ADMIN'">
            ...
            <el-menu-item index="/doctor">医护人员信息</el-menu-item>
            <el-menu-item index="/user">患者信息</el-menu-item>
          </el-submenu>
        </el-menu>
      </div>

      <!--  数据表格  router-view实现路由功能-->
